...
public:
  ...
  HARDWARE_INTERFACE_PUBLIC
   hardware_interface::SystemInterface::CallbackReturn on_init(const hardware_interface::HardwareInfo & info) override;
  ...
  HARDWARE_INTERFACE_PUBLIC
  hardware_interface::SystemInterface::CallbackReturn  on_activate(const rclcpp_lifecycle::State & previous_state) override;
  
  HARDWARE_INTERFACE_PUBLIC
  hardware_interface::SystemInterface::CallbackReturn  on_deactivate(const rclcpp_lifecycle::State & previous_state) override;
